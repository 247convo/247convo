...
(function(){
  ...
  async function initFullWidget() {
    ...
    try {
      const fragRes = await fetch('https://two47convo.onrender.com/static/widget-fragment.html');
    ...
    script.src = `https://two47convo.onrender.com/static/247convo-script.js?client_id=${client_id}`;
    script.defer = true;
