...
(function(){
  ...
  async function initFullWidget() {
    ...
    link.rel = 'stylesheet';
    link.href = 'https://two47convobot.onrender.com/247convo-style.css';
    document.head.appendChild(link);

    // e) Inject chat widget HTML fragment
    try {
      const fragRes = await fetch('https://two47convobot.onrender.com/widget-fragment.html');
    ...
    script.src = `https://two47convobot.onrender.com/247convo-script.js?client_id=${client_id}`;
    script.defer = true;
